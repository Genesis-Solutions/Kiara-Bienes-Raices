...
describe('insertProcess', () => {
    it('debe ejecutar la consulta SQL correcta para insertar un proceso', async () => {
        ...
        /*
        Verifica si la función "execute" de la base de datos fue llamada con los parámetros especificados.
        @param sqlQuery la consulta SQL que se espera que se ejecute
        @param params los parámetros que se esperan que se pasen a la consulta SQL
        @return true si la función "execute" se llamó con los parámetros esperados, de lo contrario false
        */
